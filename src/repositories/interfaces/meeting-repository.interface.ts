...
export interface IMeetingRepository extends BaseRepository<IMeeting> {
  ...
  findPreContractMeetingsForClient(clientId: string, query: ClientMeetingQueryParamsDTO): Promise<IMeeting[]>;
  countPreContractMeetingsForClient(clientId: string, query: ClientMeetingQueryParamsDTO): Promise<number>;
  findPreContractMeetingsForFreelancer(freelancerId: string, query: FreelancerMeetingQueryParamsDTO): Promise<IMeeting[]>;
