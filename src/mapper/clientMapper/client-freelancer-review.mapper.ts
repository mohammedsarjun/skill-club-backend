...
export const mapReviewToFreelancerReviewItemDTO = (review: IReview | IReviewDocument, reviewerData: { name: string; companyName?: string; logo?: string }): FreelancerReviewItemDTO => {
  return {
