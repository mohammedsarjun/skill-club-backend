...
import { FreelancerWithdrawalListItemDTO, FreelancerWithdrawalDetailDTO } from '../../dto/freelancerDTO/freelancer-withdrawal.dto';
...
export function mapContractTransactionToFreelancerWithdrawalDetailDTO(
  ...
  return {
    ...
    description: transaction.description,
    createdAt: transaction.createdAt ? transaction.createdAt.toISOString() : new Date().toISOString(),
    updatedAt: transaction.updatedAt ? transaction.updatedAt.toISOString() : new Date().toISOString(),
